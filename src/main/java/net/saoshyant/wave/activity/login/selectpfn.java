...
public class selectpfn extends Activity {

    ImageButton btnLogin;
    Button changecountry;
    EditText inputrealname,inputfrequency,inputpassword;
String countrycode;
    ProgressBar vprog;
    public static final String URL_REQUEST = "http://saoshyant.net/wave/selectPFN.php";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.selectpfn);
...
changecountry=(Button) findViewById(R.id.changecountry);
        changecountry.setOnClickListener(new View.OnClickListener() {

            public void onClick(View v) {
                Intent upanel5 = new Intent(selectpfn.this, selectcountry.class);
    ...
    {
        String password, realname,frequency;
