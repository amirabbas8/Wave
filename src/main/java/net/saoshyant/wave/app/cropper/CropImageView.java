...
package net.saoshyant.wave.app.cropper;
...
import net.saoshyant.wave.app.cropper.cropwindow.CropOverlayView;
import net.saoshyant.wave.app.cropper.cropwindow.edge.Edge;
import net.saoshyant.wave.app.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
    ...
    public RectF getActualCropRect() {
        ...
        return new RectF(actualCropLeft, actualCropTop, actualCropRight, actualCropBottom);
    }
